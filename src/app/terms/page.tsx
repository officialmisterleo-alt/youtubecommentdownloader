    ...
    <div className="flex-1">
      <div className="max-w-3xl mx-auto px-4 py-12 sm:py-16">
        <div className="bg-[#171717] border border-white/[0.07] rounded-2xl p-6 sm:p-10 lg:p-14">
          ...
          <h1 className="text-3xl sm:text-4xl font-bold font-jakarta text-[#e5e2e1] mb-2">Terms of Service</h1>
          ...
          <section className="mb-8">
            <h2 className="text-xl font-bold font-jakarta text-[#e5e2e1] mb-3 pb-2 border-b border-white/[0.07]">1. Acceptance of Terms</h2>
          ...
          <section className="mb-8">
            <h2 className="text-xl font-bold font-jakarta text-[#e5e2e1] mb-3 pb-2 border-b border-white/[0.07]">2. Description of Service</h2>
          ...
          <section className="mb-8">
            <h2 className="text-xl font-bold font-jakarta text-[#e5e2e1] mb-3 pb-2 border-b border-white/[0.07]">3. User Accounts and Responsibilities</h2>
            <p className="text-[#888888] leading-relaxed mb-3">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-bold font-jakarta text-[#e5e2e1] mb-3 pb-2 border-b border-white/[0.07]">4. Acceptable Use Policy</h2>
          ...
          <section className="mb-8">
            <h2 className="text-xl font-bold font-jakarta text-[#e5e2e1] mb-3 pb-2 border-b border-white/[0.07]">5. Subscriptions and Billing</h2>
            <p className="text-[#888888] leading-relaxed mb-3">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-bold font-jakarta text-[#e5e2e1] mb-3 pb-2 border-b border-white/[0.07]">6. Refund Policy</h2>
            <p className="text-[#888888] leading-relaxed mb-3">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-bold font-jakarta text-[#e5e2e1] mb-3 pb-2 border-b border-white/[0.07]">7. Data and Privacy</h2>
            <p className="text-[#888888] leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-bold font-jakarta text-[#e5e2e1] mb-3 pb-2 border-b border-white/[0.07]">8. Intellectual Property</h2>
            <p className="text-[#888888] leading-relaxed mb-3">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-bold font-jakarta text-[#e5e2e1] mb-3 pb-2 border-b border-white/[0.07]">9. Disclaimer of Warranties</h2>
            <p className="text-[#888888] leading-relaxed mb-3">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-bold font-jakarta text-[#e5e2e1] mb-3 pb-2 border-b border-white/[0.07]">10. Limitation of Liability</h2>
            <p className="text-[#888888] leading-relaxed mb-3">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-bold font-jakarta text-[#e5e2e1] mb-3 pb-2 border-b border-white/[0.07]">11. Governing Law</h2>
            <p className="text-[#888888] leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-bold font-jakarta text-[#e5e2e1] mb-3 pb-2 border-b border-white/[0.07]">12. Changes to These Terms</h2>
            <p className="text-[#888888] leading-relaxed">
          ...
          <section className="mb-2">
            <h2 className="text-xl font-bold font-jakarta text-[#e5e2e1] mb-3 pb-2 border-b border-white/[0.07]">13. Contact</h2>
            <p className="text-[#888888] leading-relaxed">
