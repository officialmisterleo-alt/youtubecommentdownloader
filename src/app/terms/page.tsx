  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f]">
      ...
      <div className="max-w-3xl mx-auto px-4 py-12 sm:py-16">
        <div className="bg-white rounded-2xl p-6 sm:p-10 lg:p-14 text-gray-900">

          <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-2">Terms of Service</h1>
          <p className="text-gray-500 text-sm mb-10">Effective Date: March 2026</p>
          ...
          <section className="mb-8">
            <h2 className="text-xl font-bold text-gray-900 mb-3 pb-2 border-b border-gray-200">1. Acceptance of Terms</h2>
          ...
          <section className="mb-8">
            <h2 className="text-xl font-bold text-gray-900 mb-3 pb-2 border-b border-gray-200">2. Description of Service</h2>
          ...
          <section className="mb-8">
            <h2 className="text-xl font-bold text-gray-900 mb-3 pb-2 border-b border-gray-200">3. User Accounts and Responsibilities</h2>
            <p className="text-gray-700 leading-relaxed mb-3">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-bold text-gray-900 mb-3 pb-2 border-b border-gray-200">4. Acceptable Use Policy</h2>
          ...
          <section className="mb-8">
            <h2 className="text-xl font-bold text-gray-900 mb-3 pb-2 border-b border-gray-200">5. Subscriptions and Billing</h2>
            <p className="text-gray-700 leading-relaxed mb-3">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-bold text-gray-900 mb-3 pb-2 border-b border-gray-200">6. Refund Policy</h2>
            <p className="text-gray-700 leading-relaxed mb-3">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-bold text-gray-900 mb-3 pb-2 border-b border-gray-200">7. Data and Privacy</h2>
            <p className="text-gray-700 leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-bold text-gray-900 mb-3 pb-2 border-b border-gray-200">8. Intellectual Property</h2>
            <p className="text-gray-700 leading-relaxed mb-3">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-bold text-gray-900 mb-3 pb-2 border-b border-gray-200">9. Disclaimer of Warranties</h2>
            <p className="text-gray-700 leading-relaxed mb-3">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-bold text-gray-900 mb-3 pb-2 border-b border-gray-200">10. Limitation of Liability</h2>
            <p className="text-gray-700 leading-relaxed mb-3">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-bold text-gray-900 mb-3 pb-2 border-b border-gray-200">11. Governing Law</h2>
            <p className="text-gray-700 leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-bold text-gray-900 mb-3 pb-2 border-b border-gray-200">12. Changes to These Terms</h2>
            <p className="text-gray-700 leading-relaxed">
          ...
          <section className="mb-2">
            <h2 className="text-xl font-bold text-gray-900 mb-3 pb-2 border-b border-gray-200">13. Contact</h2>
            <p className="text-gray-700 leading-relaxed">
      ...
      <footer className="border-t border-[#1f1f2e] py-8 px-4">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div className="text-gray-700 text-xs">© 2025–2026 YouTube Comment Downloader</div>
