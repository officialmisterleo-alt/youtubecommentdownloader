  ...
  if (success) {
    return (
      <div className="min-h-screen bg-[#0a0a0a] flex flex-col items-center justify-center px-4">
        <div className="bg-[#171717] border border-white/[0.07] rounded-2xl p-8 w-full max-w-md text-center">
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] flex flex-col items-center justify-center px-4">
      ...
      <div className="bg-[#171717] border border-white/[0.07] rounded-2xl p-8 w-full max-w-md">
        ...
        <button onClick={handleGoogleSignIn} className="w-full flex items-center justify-center gap-3 bg-white text-gray-900 font-medium py-3 px-4 rounded-lg hover:bg-gray-100 transition-colors mb-4">
