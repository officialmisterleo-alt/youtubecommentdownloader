      ...
      <div className="max-w-3xl mx-auto px-4 py-12 sm:py-16">
        <div className="bg-white rounded-2xl p-6 sm:p-10 lg:p-14 text-gray-900">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-bold text-gray-900 mb-3 pb-2 border-b border-gray-200">1. Information We Collect</h2>
          ...
          <section className="mb-8">
            <h2 className="text-xl font-bold text-gray-900 mb-3 pb-2 border-b border-gray-200">2. How We Use Your Information</h2>
          ...
          <section className="mb-8">
            <h2 className="text-xl font-bold text-gray-900 mb-3 pb-2 border-b border-gray-200">3. Data Retention</h2>
            <p className="text-gray-700 leading-relaxed mb-3">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-bold text-gray-900 mb-3 pb-2 border-b border-gray-200">4. Third-Party Services</h2>
            <p className="text-gray-700 leading-relaxed mb-3">We rely on the following trusted third-party services to operate:</p>
            <ul className="list-disc list-inside text-gray-700 leading-relaxed space-y-2">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-bold text-gray-900 mb-3 pb-2 border-b border-gray-200">5. Cookies</h2>
            <p className="text-gray-700 leading-relaxed mb-3">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-bold text-gray-900 mb-3 pb-2 border-b border-gray-200">6. Your Rights</h2>
            <p className="text-gray-700 leading-relaxed mb-3">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-bold text-gray-900 mb-3 pb-2 border-b border-gray-200">7. Security</h2>
            <p className="text-gray-700 leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-bold text-gray-900 mb-3 pb-2 border-b border-gray-200">8. GDPR and CCPA</h2>
            <p className="text-gray-700 leading-relaxed mb-3">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-bold text-gray-900 mb-3 pb-2 border-b border-gray-200">9. Children&apos;s Privacy</h2>
            <p className="text-gray-700 leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-bold text-gray-900 mb-3 pb-2 border-b border-gray-200">10. Changes to This Policy</h2>
            <p className="text-gray-700 leading-relaxed">
          ...
          <section className="mb-2">
            <h2 className="text-xl font-bold text-gray-900 mb-3 pb-2 border-b border-gray-200">11. Contact</h2>
            <p className="text-gray-700 leading-relaxed">
