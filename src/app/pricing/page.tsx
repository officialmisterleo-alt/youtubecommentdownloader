...
const plans = [
  {
    ...
    features: ['100 comments per video', '1,000 comments/month', 'No account required', 'Basic sorting'],
  ...
  },
  {
    ...
    features: ['10,000 comments per video', '100,000 comments/month', 'All export formats', 'Reply thread capture', 'Email support', 'Priority processing', 'Basic sorting & filtering', 'AI Analysis (up to 10,000 comments)'],
  ...
  },
  {
    ...
    features: ['100,000 comments per video', '1,000,000 comments/month', 'All export formats', 'Bulk channel/playlist', 'Scheduled exports', '3 team seats', 'Priority email support', 'AI Analysis (up to 50,000 comments)'],
  ...
  },
  {
    ...
    features: ['Unlimited comments/month', 'Unlimited per video', 'Dedicated API quota', '10 team seats', 'SSO / SAML', 'White-label exports', 'Custom data retention', '99.9% SLA', 'Priority phone support', 'Custom onboarding', 'AI Analysis (up to 100,000 comments)'],
    notIncluded: [],
...
const comparisonFeatures = [
  ...
  { label: 'Monthly comment quota', free: '1k', pro: '100k', business: '1M', enterprise: 'Unlimited' },
